    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="px-4 py-6">
        ...
        <div className="grid grid-cols-2 gap-4">
          <button className="bg-white p-4 rounded-xl shadow-sm border border-gray-100 flex items-center space-x-3 hover:shadow-md transition-shadow">
        ...
        <div className="flex items-center justify-around py-2">
          <button
            ...
            className={`flex flex-col items-center py-2 px-3 ${
              activeTab === 'dashboard' ? 'text-cyan-600' : 'text-gray-400'
            }`}
          >
            {activeTab === 'dashboard' ? (
          ...
          <button
            ...
            className={`flex flex-col items-center py-2 px-3 ${
              activeTab === 'appointments' ? 'text-cyan-600' : 'text-gray-400'
            }`}
          >
          ...
          <button
            ...
            className={`flex flex-col items-center py-2 px-3 ${
              activeTab === 'records' ? 'text-cyan-600' : 'text-gray-400'
            }`}
          >
            {activeTab === 'records' ? (
              <DocumentSolid className="w-6 h-6" />
            ) : (
          ...
          <button
            ...
            className={`flex flex-col items-center py-2 px-3 ${
              activeTab === 'profile' ? 'text-cyan-600' : 'text-gray-400'
            }`}
          >
            {activeTab === 'profile' ? (
